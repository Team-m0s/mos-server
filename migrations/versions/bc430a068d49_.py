...
def upgrade() -> None:
    ...
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('category', sa.Enum('korean', 'english', 'chinese', 'japanese', 'vietnamese', 'french', 'german', 'italian', 'spanish', 'portuguese', 'russian', 'turkish', 'indonesian', 'arabic',
                                  'bank', 'rental', 'law', 'visa', 'flight', 'others', 'information', 'promotion', name='postcategory'), nullable=True),
